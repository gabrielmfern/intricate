kernel void compute_loss(
    ...
    for (int output_index = 0; output_index < outputs_amount; output_index++) {
        ...
        sample_loss -= expected_output * (float)log((double)output + 0.0000000000000000000000000000000000000000001)
                            + (1.0f - expected_output) * (float)log(1.0 - (double)output + 0.0000000000000000000000000000000000000000001);
    }
...
kernel void compute_loss_to_output_derivatives(
    ...
    loss_to_output_derivatives[flat_i] = (float) -((double)expected_output / ((double)output + 0.0000000000000000000000000000000000000000001)
                                - (1.0 - (double)expected_output) / (1.0 - (double)output + 0.0000000000000000000000000000000000000000001));
}