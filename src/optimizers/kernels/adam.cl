kernel void compute_update_vectors(
    ...
    global float* last_moment_second_estimate,
    global float* current_moment_second_estimate,

    global float* update_vector,

    int gradients_amount,
    int has_last_moment_first_estimate,
    int has_last_moment_second_estimate,
    ...
    if (has_last_moment_first_estimate == 1) {
    ...
    if (has_last_moment_second_estimate == 1) {
